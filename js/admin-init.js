...
function buildSampleData() {
  ...
  const athletes = [
    { id: 'К1М-1', displayName: 'Иван Петров', boatClass: 'К1М' },
    { id: 'К1М-2', displayName: 'Роман Сидоров', boatClass: 'К1М' },
    { id: 'К1М-3', displayName: 'Дмитрий Козлов', boatClass: 'К1М' },
    { id: 'К1М-4', displayName: 'Алексей Новиков', boatClass: 'К1М' },
    { id: 'К1М-5', displayName: 'Сергей Волков', boatClass: 'К1М' },
    { id: 'К1Ж-1', displayName: 'Анна Волкова', boatClass: 'К1Ж' },
    { id: 'К1Ж-2', displayName: 'Мария Смирнова', boatClass: 'К1Ж' },
    { id: 'К1Ж-3', displayName: 'Елена Кузнецова', boatClass: 'К1Ж' },
    { id: 'К1Ж-4', displayName: 'Ольга Морозова', boatClass: 'К1Ж' },
    { id: 'П1М-1', displayName: 'Егор Иванов', boatClass: 'П1М' },
    { id: 'П1М-2', displayName: 'Никита Соколов', boatClass: 'П1М' },
    { id: 'П1М-3', displayName: 'Артём Попов', boatClass: 'П1М' },
    { id: 'П1Ж-1', displayName: 'Татьяна Федорова', boatClass: 'П1Ж' },
    { id: 'П1Ж-2', displayName: 'Наталья Михайлова', boatClass: 'П1Ж' },
    { id: 'П1Ж-3', displayName: 'Юлия Васильева', boatClass: 'П1Ж' }
  ];
...
function bindAdminEvents() {
  ...
  document.getElementById('addAthlete').addEventListener('click', () => {
    ...
    d.athletes.push({ id: newId, displayName: name, boatClass });
