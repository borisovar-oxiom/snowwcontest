...
function initRatingPage() {
  if (typeof window !== 'undefined' && window.SnowContestConstants) {
    const label = window.SnowContestConstants.CLUB_COLUMN_HEADER || 'Клуб';
    document.querySelectorAll('th[data-club-header]').forEach(th => {
